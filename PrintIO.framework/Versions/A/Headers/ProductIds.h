...
extern int PRODUCT_ACRYLIC_CATCH_ALL();
extern int PRODUCT_ACRYLIC_PRINTS();
extern int PRODUCT_ACRYLIC_TRAYS();
extern int PRODUCT_BEACH_BAGS();
...
extern int PRODUCT_LUGGAGE_TAGS();
...
extern int PRODUCT_WRAPPING_PAPER();
...
extern int PRODUCT_CUSTOM_PHOTOS_SUNGLASSES();
extern int PRODUCT_DUVET_COVER();
extern int PRODUCT_GAMING_SKINS();
extern int PRODUCT_MEDIA_PLAYER_SKINS();
extern int PRODUCT_MESSENGER_BAG();
extern int PRODUCT_MODERN_ORNAMENTS();
extern int PRODUCT_NECKTIES();
extern int PRODUCT_PHONE_SKINS();
extern int PRODUCT_PHOTO_ALBUM();
...
extern int PRODUCT_TOTE_BAG();
extern int PRODUCT_UMBRELLAS();
extern int PRODUCT_WALL_SKINS();
extern int PRODUCT_WATER_BOTTLES();
extern int PRODUCT_PHOTO_BOOK();
extern int PRODUCT_WALL_DECAL();
