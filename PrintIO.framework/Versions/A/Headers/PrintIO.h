 ...
 */
-(id)initWithEnvironment:(int)type productionRecipeId:(NSString *)pRecipeId stagingRecipeId:(NSString *)sRecipeId;
...
/**
 ...
 @param sRecipeId Staging recipeId provided by PrintIO
 */
-(id)initWithViewController:(id)viewController environment:(int)type productionRecipeId:(NSString *)pRecipeId stagingRecipeId:(NSString *)sRecipeId;
...
/**
 ...
 Example:
 NSArray *productsInHero = @[[NSNumber numberWithInt:PRODUCT_PHONE_CASES()], [NSNumber numberWithInt:PRODUCT_TABLET_CASES()]];
 */
...
/**
 Test Google Analytics E-Commerce in live mode
 
 @param set Default value is NOs
 */
-(void)testECommerceInLive:(BOOL)set;
...
-(void)showMuchMoreToCome:(BOOL)show DEPRECATED_ATTRIBUTE;
-(void)hideMuchMoreToCome:(BOOL)hide DEPRECATED_ATTRIBUTE;
-(void)setFeaturedProductsDefaultView:(PIOFeatureProductsView)viewType DEPRECATED_ATTRIBUTE;
-(void)enableAnimationInProductsList:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)setPassedImageAsThumbForOnePhotoTemplate:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)setIconForHelpButtonInCustomizeProduct:(NSString *)imagePath visible:(BOOL)visible DEPRECATED_ATTRIBUTE;
-(void)removePlusFromAddMoreProductsButton:(BOOL)remove DEPRECATED_ATTRIBUTE;
...
-(void)sideMenuBackgroungImage:(NSString *)path DEPRECATED_ATTRIBUTE;
-(void)sideMenuShowOptionsAsList:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)sideMenuHideInfoHeader:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)sideMenuHideAccountsHeader:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)sideMenuHideOptionsHeader:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)setShareText:(NSString *)shareText additionalText:(NSString *)additionalText DEPRECATED_ATTRIBUTE;
-(void)setExtraData:(NSMutableDictionary *)extraData DEPRECATED_ATTRIBUTE;
-(void)hideWatchVideoButton:(BOOL)hide DEPRECATED_ATTRIBUTE;
-(void)hideEditButtonInShoppingCart:(BOOL)set DEPRECATED_ATTRIBUTE;
-(void)showPlusSignOnAddButton:(BOOL)set DEPRECATED_ATTRIBUTE;
