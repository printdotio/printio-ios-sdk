...
/**
 Set background color for active photo sources
 
 @param color Background color
 */
-(void)setSideMenuActivePSColor:(UIColor *)color;
...
/**
 Set color for buttons in toolbar on Customize Product screen
 
 @param color Color for icon and text
 @param selectedStateColor Color for icon and text when button has selected state
 */
-(void)setToolbarButtonsColor:(UIColor *)color selectedStateColor:(UIColor *)selectedStateColor;
...
/**
 Set url for Privacy Policy. Ff set, url will be opened in About Us
 screen
 
 @param url Url to Privacy Policy
 */
-(void)setPrivacyPolicyURL:(NSURL *)url;
