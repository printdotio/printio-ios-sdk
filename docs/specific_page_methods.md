...
#### A7. Hide coming soon products from product's list. Default value is NO.
...
#### A8. Set available products. List of product ids, which will be shown in product's list.
...
#### A9. Change version of Products Screen. Default screen version is PIOProductsScreenV1.
...
#### A10. Set image url for Dymanic products list view. In order to use this method, PIOProductsScreenV2 needs to be enabled. Available from sdk v1.5.13(23)
...
#### A11. Set text for What's New Dialog. If there's no text, dialog will be hidden.
...
#### A12. Show bottom bar with search, like, share and rate us options. Available from SDK v1.5.19(24)
...
#### A13. Set which products will be in hero, on Products page, by providing product ids. Max number of products is five.
...
D4. Hide shopping cart icon from Photo Sources screen. Dafault value is NO.
...
X. Hides cart button from navigation bar, when cart is empty. Default value is NO.
...
![enter image description here][47]
 ...
 [10]: https://lh5.googleusercontent.com/-OuNYjHtIGF4/VE59iKnBAqI/AAAAAAAAArY/LlhVlht41NI/w400-h710-no/shopping_cart_1.png
