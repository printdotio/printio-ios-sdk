...
B. Set which options to use in side menu:
...
C. Hide “Options” header in Side Menu. default values is NO.
...
D. Hide “Accounts” header in Side Menu. default values is NO.
...
E. Hide “Info” header in Side Menu. Default values is NO.
...
F. Show “Options” section as a list. Default value is NO. 
...
G. Set the text to be included when a user clicks the Share this app button. Note: This is option from Side Menu, in order to use it, Side Menu needs to be enabled first. 
...
H. Hide photo source section. Default value is NO.
...
I. Set background image on Side Menu. 
...
J. Set url link to facebook page e.g. 'fb://profile/642169949144369'
...
[1]: https://lh4.googleusercontent.com/-H3yjdwdOXsY/VEo52uqdBhI/AAAAAAAAAP4/NBYJGY-WDWs/w501-h889-no/12a.png
[2]: https://lh5.googleusercontent.com/-KgbunHao6t4/VEo53SdvKpI/AAAAAAAAAPo/6ftWE_SiqY0/w501-h889-no/12b.png
