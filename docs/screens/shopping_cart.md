...
B. Customize the icon for the back button in the Shopping Cart screen. 
...
C. Method to Hide or Show “Edit” button on Shopping Cart screen. Default value is NO.
...
D. Visibility for Add More Products button. Default value is YES.
...
E. Disable Preview screen for products on Shopping Cart screen (click on item in cart list). Default value is YES. 
...
F. Add Promo code to get discount for products on Shopping cart screen. 

- setPromoCode 

https://github.com/printdotio/printio-ios-sdk/blob/master/docs/code_customization.md#--setpromocode

G. Remove plus sign from 'Add More Products' button. Default value is NO.
...
[1]: https://lh6.googleusercontent.com/-yKVfa0_JrYo/VEo59RSIF0I/AAAAAAAAAQc/qn3gg2vmAvs/w501-h889-no/5.png
[2]: https://lh5.googleusercontent.com/-XM3mGuk2YVk/VEo59x0taQI/AAAAAAAAARU/NcJ2rrR8grg/w501-h889-no/5a.png
